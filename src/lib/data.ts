...
export const upcomingEvents: UpcomingEvent[] = [
  ...
  },
  {
    ...
    description:
      "Ashtotram, Bhajans, Balvikas Programs, and Narayana Seva.",
  },
  {
...
export const galleryCategories: GalleryCategory[] = [
  {
    ...
    images: [
      {
        src: img("/assets/img/gallery/balvikas/balvikas1.jpg"),
        title: "Balvikas class",
        description: "New Balvikas center in Ramar temple",
      },
      {
        src: img("/assets/img/gallery/balvikas/balvikas2.jpg"),
        title: "Saptaham",
        description: "Sai Saptaham by past Balvikas",
      },
      {
        src: img("/assets/img/gallery/balvikas/balvikas3.jpg"),
        title: "Narayana seva",
        description: "Narayana seva by balvikas children",
      },
      {
        src: img("/assets/img/gallery/balvikas/summer camp.jpg"),
        title: "Summer camp",
        description: "Summer camp in venkateshwara school",
      },
      {
        src: img("/assets/img/gallery/balvikas/navarathri.jpg"),
        title: "Navarathri celebration",
        description: "Navarathri celebration by Balvikas children",
      },
      {
        src: img("/assets/img/gallery/balvikas/sai protein.jpg"),
        title: "Sai Protein",
        description: "Sai Protein packed with love by Balvikas children",
      },
    ],
  },
  {
    ...
    images: [
      {
        src: img("/assets/img/gallery/balvikas/balvikas4.jpg"),
        title: "Temple cleaning",
        description: "Temple cleaning in Ramar Temple",
      },
      {
        src: img("/assets/img/gallery/balvikas/balvikas5.jpg"),
        title: "Temple cleaning",
        description: "Temple cleaning in Shiva Temple",
      },
      {
        src: img("/assets/img/gallery/temple-cleaning/temple-cleaning1.jpg"),
        title: "Temple cleaning",
        description: "Seva with love, purity and gratitude",
      },
    ],
  },
  {
    ...
    images: [
      {
        src: img("/assets/img/gallery/balvikas/bhajans.jpg"),
        title: "Special Bhajans",
        description: "Special bhajans by sai members",
      },
      {
        src: img("/assets/img/gallery/bhajans/bhajans1.jpg"),
        title: "Bhajans",
        description: "Soulful singing at the Divine Lotus Feet",
      },
    ],
  },
  {
    ...
    images: [
      {
        src: img("/assets/img/gallery/balvikas/christmas.jpg"),
        title: "Christ celebrations",
        description: "Christ celebrations in samithi",
      },
      {
        src: img("/assets/img/gallery/balvikas/nagarsankirtan.jpg"),
        title: "Nagarsankirtan",
        description: "Nagarsankirtan on Margazhi month",
      },
      {
        src: img("/assets/img/gallery/balvikas/buttermilk.jpg"),
        title: "Buttermilk",
        description: "Buttermilk seva on may month",
      },
      {
        src: img("/assets/img/gallery/other/other1.jpg"),
        title: "Other services",
        description: "Community outreach in action",
      },
    ],
  },
];
...
export const homeGalleryImages: GalleryImage[] = [
  {
    src: img("/assets/img/gallery/balvikas/balvikas1.jpg"),
    title: "Balvikas",
    description: "Balvikas class for Group 1 children",
  },
  {
    src: img("/assets/img/gallery/balvikas/summer camp.jpg"),
    title: "Summer Camp",
    description: "Summer camp in venkateswara school",
  },
  {
    src: img("/assets/img/gallery/balvikas/navarathri.jpg"),
    title: "Navarathri celebration",
...
export const aboutSections = [
  {
    ...
    items: [
      {
        strong: "Bhajans and Study Circles:",
        text: " Weekly devotional singing and satsangs.",
      },
      {
        strong: "Service Projects:",
        text: " Annadanam (free food distribution), medical camps, blood donation, and Narayana Seva.",
      },
      {
        strong: "Balvikas:",
        text: " Spiritual education for children to cultivate character and values.",
      },
      {
        strong: "Youth Seva:",
        text: " Involvement of Sai Youth in service, leadership, and social transformation initiatives.",
      },
      {
        strong: "Festival Celebrations:",
        text: " Spiritual celebrations including Gurupoornima, Swami's Birthday, and Mahashivaratri.",
      },
    ],
  },
];
