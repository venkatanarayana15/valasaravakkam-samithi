...
export default function BottomNav() {
  ...
  return (
    ...
    >
        <div className="bottom-nav-enter mx-auto mb-2 w-[calc(100%-1rem)] max-w-md rounded-2xl border border-slate-200 bg-white/90 px-1 py-0.5 shadow-[0_-6px_30px_rgba(4,11,20,0.15)] backdrop-blur-xl dark:border-white/10 dark:bg-[#0a0f1a]/95 dark:shadow-[0_-6px_30px_rgba(4,11,20,0.5)] sm:mb-3 sm:px-1.5 sm:py-1">
