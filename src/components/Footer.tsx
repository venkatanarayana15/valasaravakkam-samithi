    ...
    <footer className="border-t border-gray-200 bg-white py-4 dark:border-gray-700 dark:bg-[#0f172a] sm:py-6">
      <div className="px-4">
        ...
        <div className="mb-4 text-center text-sm dark:text-gray-400">
          ...
          <Link href="/" className="text-[#0a58ca] hover:underline dark:text-[#7dd3fc]">
        ...
        <div className="flex items-center justify-center gap-4 text-xl text-[#45505b] dark:text-gray-400">
          {socialLinks.map((link) => (
            <a
              ...
              className="transition hover:text-[#0d6efd] dark:hover:text-[#7dd3fc]"
            >
          ...
          <a
            ...
            rel="noopener noreferrer"
            aria-label="WhatsApp"
            className="text-[#158924] transition hover:text-[#0d6efd] dark:text-[#4ade80] dark:hover:text-[#7dd3fc]"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="size-5">
